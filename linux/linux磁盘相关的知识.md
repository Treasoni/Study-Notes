...
一块物理磁盘最初是"一整块"，如果直接使用，不便于管理，因此我们要"分区（Partition）"。比如我们有一个1T的硬盘，为了方便管理于是分成了D,C,E等分区。
...
![](media/image2.png){width="5.768055555555556in" height="2.3875in"}
...
这里填的分区号，表示的是这个磁盘分成几个区，如果是1，那么整个磁盘就是一个分区。
