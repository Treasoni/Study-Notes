---
title: Hermes 规则配置实战指南
tags: [hermes, agent, ai, 规则配置, 实战指南]
created: 2026-08-30
updated: 2026-08-30
status: done
source_project: hermes-rules-config
---

# Hermes 规则配置实战指南

> 本笔记属于 [[Hermes Agent MOC|Hermes Agent 学习笔记]] 的**规则配置分册**；建议先读过 [[Hermes Agent 上手实战/README|上手实战分册]]，工具接入另见 [[Hermes Tool 配置指南/README|工具配置分册]]。
