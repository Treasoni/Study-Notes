...
3. **部署后运维**：多平台日志、升级回滚、安全基线、Dashboard 认证（第 9~11 章）

[!tip] 大白话
把本册想象成给 Hermes「**买一台专属服务器并接上三条电话线**」：第 1~2 章把服务器装好并让它 24 小时开机；第 3~8 章分别接上微信、企微、飞书、QQ 四部电话；第 9~11 章教你日常维护、上锁和给 Web 控制台设门禁。每一章都独立可照抄，产物（命令 / .env / compose 文件）先睹为快再逐段拆讲。
...
| 11 | [[11-Dashboard认证配置实战\|Dashboard 认证配置实战]] | 公网暴露控制台必须认证；`basic_auth` 哈希 / 仅本机监听两方案 | 安全 |
