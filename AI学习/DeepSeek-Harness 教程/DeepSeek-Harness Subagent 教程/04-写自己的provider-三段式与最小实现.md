---
title: "DeepSeek-Harness Subagent 开发 · 第4章 写自己的 provider——三段式与最小实现"
...
> [!note] 分册导航
> [[DeepSeek-Harness Subagent 教程/README|📋 返回分册首页]] · [[03-现成provider家族-选用挂载跑起来|← 上一章]] · [[05-生命周期深度-oneshot与continuable与委派深度|下一章 →]]
...
- ← [[03-现成provider家族-选用挂载跑起来|上一章]]
- → [[05-生命周期深度-oneshot与continuable与委派深度|下一章]]
