---
title: "DeepSeek-Harness Subagent 开发 · 第3章 现成 provider 家族——选用、挂载、跑起来"
...
> [!note] 分册导航
> [[DeepSeek-Harness Subagent 教程/README|📋 返回分册首页]] · [[02-核心契约-ctxsubagents与SubagentProvider接口|← 上一章]] · [[04-写自己的provider-三段式与最小实现|下一章 →]]
...
- ← [[02-核心契约-ctxsubagents与SubagentProvider接口|上一章]]
- → [[04-写自己的provider-三段式与最小实现|下一章]]
