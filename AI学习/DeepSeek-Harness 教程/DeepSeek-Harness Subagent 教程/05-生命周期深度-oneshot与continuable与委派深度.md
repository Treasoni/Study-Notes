---
title: "DeepSeek-Harness Subagent 开发 · 第5章 生命周期深度——one-shot / continuable 与委派深度"
...
> [!note] 分册导航
> [[DeepSeek-Harness Subagent 教程/README|📋 返回分册首页]] · [[04-写自己的provider-三段式与最小实现|← 上一章]] · [[06-工具化-把provider暴露成模型可调能力|下一章 →]]
...
- ← [[04-写自己的provider-三段式与最小实现|上一章]]
- → [[06-工具化-把provider暴露成模型可调能力|下一章]]
