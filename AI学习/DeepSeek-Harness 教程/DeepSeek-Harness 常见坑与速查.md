...
- **下一步**：回顾 [[DeepSeek-Harness 是什么|第 1 章]]心智模型 → [[DeepSeek-Harness 安装与快速上手|第 2 章]]环境 → [[DeepSeek-Harness 配置体系|第 3 章]]核心 → [[DeepSeek-Harness 与ClaudeCode对照迁移|第 4 章]]实战，把例子换成你自己的工具（API 封装 / 笔记检索 / 构建脚本），流程不变。
