...
sources:
  ...
  - R2: "Claude Code 对齐 PR #6431（命令/概念与 Claude Code 对齐）(esengine/DeepSeek-Reasonix, 2026) https://github.com/esengine/DeepSeek-Reasonix/pull/6431"
  - R3: "成本实测 Issue #7907（用户对账：99.6% 命中率、¥1.37/全天）(esengine/DeepSeek-Reasonix, 2026) https://github.com/esengine/DeepSeek-Reasonix/issues/7907"
  - R4: "智源 BAAI 报道（项目自报：99.82% 命中率、$61→$12，非独立评测）(BAAI Hub, 2026) https://hub.baai.ac.cn/view/54971"
concepts:
  - migration
  - command-mapping
  - concept-mapping
