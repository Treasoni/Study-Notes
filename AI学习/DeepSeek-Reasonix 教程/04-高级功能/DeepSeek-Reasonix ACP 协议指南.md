...
sources:
  ...
  - R2: "ACP 文档 ACP.md（+ ACP.zh-CN.md）：ACP v1、能力协商、session 生命周期、协作模式与工具审批 (esengine, 2026) https://github.com/esengine/DeepSeek-Reasonix/blob/main-v2/docs/ACP.md"
  - R3: "CLI 参考 CLI.zh-CN 与 CLI-REFERENCE：reasonix acp 命令 (esengine, 2026) https://github.com/esengine/DeepSeek-Reasonix/blob/main-v2/docs/CLI.zh-CN.md"
  - R4: "Claude Code 对齐 PR #6431（Ask/Auto/Yolo ↔ configOptions.tool_approval）(esengine, 2026) https://github.com/esengine/DeepSeek-Reasonix/pull/6431"
concepts:
  - acp-protocol
