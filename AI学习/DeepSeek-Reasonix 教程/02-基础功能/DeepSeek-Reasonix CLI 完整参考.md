...
sources:
  - R1: "官方 CLI 参考 v1（CLI-REFERENCE.md，命令全集与 v1 特有参数）(esengine, 2026-08) https://github.com/esengine/DeepSeek-Reasonix/blob/v1/docs/CLI-REFERENCE.md"
  - R2: "官方 CLI 参考 main-v2（CLI.zh-CN.md，当前主版本命令）(esengine, 2026-08) https://github.com/esengine/DeepSeek-Reasonix/blob/main-v2/docs/CLI.zh-CN.md"
  - R3: "DeepSeek-Reasonix 官方仓库 README（命令总览）(esengine, 2026-08) https://github.com/esengine/DeepSeek-Reasonix"
  - R4: "Claude Code 对齐 PR #6431（命令与交互层对齐）(esengine, 2026-08) https://github.com/esengine/DeepSeek-Reasonix/pull/6431"
concepts:
  - reasonix-cli
  - command-reference
  - headless
