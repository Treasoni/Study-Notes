...
| **🆕 国内仿制品对比/企业选型** | [[OpenClaw与国内仿制品对比]] |
| **🆕 搭建企业文档助手** | [[OpenClaw本地智能助手搭建指南]] |
...
| [[OpenClaw与国内仿制品对比]] | `企业选型`, `对比`, `国内替代` | 国内仿制品（MaxClaw/KimiClaw/QClaw/PowerClaw）对比、企业选型指南、安全风险 |
| [[OpenClaw本地智能助手搭建指南]] | `知识库`, `RAG`, `培训` | 本地部署 + 知识库搭建 + 培训新人场景实现 |
...
3. [[OpenClaw数字人商业调查]] - 了解应用场景
   ↓
4. [[OpenClaw与国内仿制品对比]] - 企业选型参考
```

### 企业应用路径 🆕

```
1. [[OpenClaw与国内仿制品对比]] - 了解企业选型
   ↓
2. [[OpenClaw本地智能助手搭建指南]] - 搭建企业文档助手
   ↓
3. [[OpenClaw多智能体协作指南]] - 扩展多 Agent 协作
```
