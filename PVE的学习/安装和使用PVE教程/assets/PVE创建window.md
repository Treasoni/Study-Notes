...
# 2. 创建window虚拟机
当我们按照PVE创建虚拟机的你可以看[如何创建PVE虚拟机](../如何创建PVE虚拟机.md)。我们要在==**硬件**==中新增一个==**CD/DVD Drive**==来添加我们的virtio镜像。
![](assets/PVE创建window/file-20260203212732145%201.png)
...
> ⚠️ 
![](assets/PVE创建window/file-20260203212732143.png)

我们创建window中这里我们选择==**加载驱动程序**==
![](assets/PVE创建window/file-20260203212732144%201.png)
这里我们选择**浏览**
![](assets/PVE创建window/file-20260203212732145.png)
![](assets/PVE创建window/file-20260203212732144.png)
...
![](assets/PVE创建window/file-20260203212732142.png)
