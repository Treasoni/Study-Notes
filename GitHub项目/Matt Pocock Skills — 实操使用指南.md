---
title: "使用 Matt Pocock Skills — 实操使用指南"
subtitle: "从安装、触发到落地自己项目的 Agent Skills 实操手册"
tags:
  - agent-framework
  - skill-design
  - claude-code
...
一句话：`/codebase-design` 是一份**共享参考**，提供设计讨论时的统一词汇——它不执行流程，而是给其他 skill 和模型提供语言（复用素材见 `workspace/matt-pocock-skills/02_deep_research.md`）。
