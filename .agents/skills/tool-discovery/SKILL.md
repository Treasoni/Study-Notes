...
4. 扫描 `.agents/skills/*/SKILL.md`，只列出研究、资料收集、浏览器或本地资料阅读直接相关的技能。
5. 更新 `.codex/rules/research-tools.md`：列出已验证工具、适用边界、推荐选择顺序和不可用的研究型 MCP 状态。不要列出未安装工具。
...
- `.codex/rules/research-tools.md` 与 Claude Code 生成副本无漂移。
