---
url: "https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs"
title: "Verbs and File Associations - Win32 apps | Microsoft Learn"
scraped_at: 2026-09-10T15:41:44+00:00
---

Table of contents  Exit editor mode
Ask Learn Ask Learn
Reading mode Table of contents [ Read in English ](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs) Add to Plans [ Edit ](https://github.com/MicrosoftDocs/win32/blob/docs/desktop-src/shell/fa-verbs.md) Copy Markdown Print
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs) or changing directories. 
...
This topic is organized as follows:
  * [Introduction to Shortcut Menus for File System Objects](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#introduction-to-shortcut-menus-for-file-system-objects)
    * [Add Commands to a Shortcut Menu](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#add-commands-to-a-shortcut-menu)
  * [Shortcut Menu Verbs](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#shortcut-menu-verbs)
  * [Stream Non-File System Items and OpenSearch Results.](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#stream-non-file-system-items-and-opensearch-results)
  * [Register an Application to Handle Arbitrary File Types](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#register-an-application-to-handle-arbitrary-file-types)
  * [Additional Resources](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#additional-resources)
  * [Related topics](https://learn.microsoft.com/en-us/windows/win32/shell/fa-verbs#related-topics)
...
To extend the shortcut menu for a file type, you must create a registry entry for each command. A more sophisticated approach is to implement a shortcut menu (verb) handler, which allows you to extend the shortcut menu for a file type on a file-by-file basis. For more information, see [Creating Context Menu Handlers](https://learn.microsoft.com/en-us/windows/win32/shell/context-menu-handlers), and [Context Menu Reference](https://learn.microsoft.com/en-us/windows/win32/shell/context-menu-reference).
...
## Shortcut Menu Verbs
Each command on the shortcut menu is identified in the registry by its verb. These verbs are the same as those used by [**ShellExecuteEx**](https://learn.microsoft.com/en-us/windows/desktop/api/Shellapi/nf-shellapi-shellexecuteexa) when launching applications programmatically.
...
## Additional Resources
  * For additional background, see [Introduction to File Associations](https://learn.microsoft.com/en-us/windows/win32/shell/fa-intro).
  * For conceptual information about extending the Shell with file type handlers, see [Creating Shell Extension Handlers](https://learn.microsoft.com/en-us/windows/win32/shell/handlers).
