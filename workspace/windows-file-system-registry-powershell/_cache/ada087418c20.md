---
url: "https://learn.microsoft.com/en-us/windows/win32/shell/user-environment-variables"
title: "User Environment Variables - Win32 apps | Microsoft Learn"
scraped_at: 2026-09-10T15:41:44+00:00
---

Table of contents  Exit editor mode
Ask Learn Ask Learn
Reading mode Table of contents [ Read in English ](https://learn.microsoft.com/en-us/windows/win32/shell/user-environment-variables) Add to Plans [ Edit ](https://github.com/MicrosoftDocs/win32/blob/docs/desktop-src/shell/user-environment-variables.md) Copy Markdown Print
Note
Access to this page requires authorization. You can try [signing in](https://learn.microsoft.com/en-us/windows/win32/shell/user-environment-variables) or changing directories. 
...
To retrieve a copy of the environment block for a given user, use the [**CreateEnvironmentBlock**](https://learn.microsoft.com/en-us/windows/desktop/api/Userenv/nf-userenv-createenvironmentblock) function. To free an environment block created by **CreateEnvironmentBlock** , use the [**DestroyEnvironmentBlock**](https://learn.microsoft.com/en-us/windows/desktop/api/Userenv/nf-userenv-destroyenvironmentblock) function. These functions reference a pointer to an environment block. The environment block is an array of null-terminated Unicode strings. The list ends with two nulls (\0\0).
To expand a string that contains environment variables by using the environment block for a specified user, use the [**ExpandEnvironmentStringsForUser**](https://learn.microsoft.com/en-us/windows/desktop/api/Userenv/nf-userenv-expandenvironmentstringsforusera) function.
## Feedback
