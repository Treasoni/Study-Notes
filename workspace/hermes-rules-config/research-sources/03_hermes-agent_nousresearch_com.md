...
## Resetting to the default[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/personality#resetting-to-the-default "Direct link to Resetting to the default")
...
For terminal appearance, see [Skins & Themes](https://hermes-agent.nousresearch.com/docs/user-guide/features/skins).
  ...
  * [Resetting to the default](https://hermes-agent.nousresearch.com/docs/user-guide/features/personality#resetting-to-the-default)
