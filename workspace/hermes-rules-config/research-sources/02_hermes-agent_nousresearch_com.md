...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#__docusaurus_skipToContent_fallback)
On this page
...
## Supported Context Files[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#supported-context-files "Direct link to Supported Context Files")  
...
## AGENTS.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#agentsmd "Direct link to AGENTS.md")
...
### Directory Chain (git root → working directory)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#directory-chain-git-root--working-directory "Direct link to Directory Chain \(git root → working directory\)")
...
### Progressive Subdirectory Discovery[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#progressive-subdirectory-discovery "Direct link to Progressive Subdirectory Discovery")
...
info
Subdirectory context files go through the same [security scan](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#security-prompt-injection-protection) as startup context files. Malicious files are blocked.
### Example AGENTS.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#example-agentsmd "Direct link to Example AGENTS.md")
...
## SOUL.md[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#soulmd "Direct link to SOUL.md")
...
## .cursorrules[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#cursorrules "Direct link to .cursorrules")
...
## How Context Files Are Loaded[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#how-context-files-are-loaded "Direct link to How Context Files Are Loaded")
### At startup (system prompt)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#at-startup-system-prompt "Direct link to At startup \(system prompt\)")
...
### During the session (progressive discovery)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#during-the-session-progressive-discovery "Direct link to During the session \(progressive discovery\)")
...
## Security: Prompt Injection Protection[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#security-prompt-injection-protection "Direct link to Security: Prompt Injection Protection")
...
## Size Limits[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#size-limits "Direct link to Size Limits")  
| Limit  | Value  |  
| --- | --- |  
...
## Tips for Effective Context Files[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#tips-for-effective-context-files "Direct link to Tips for Effective Context Files")
...
### Per-Subdirectory Context[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#per-subdirectory-context "Direct link to Per-Subdirectory Context")
...
```
  ...
  * [Supported Context Files](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#supported-context-files)
  * [AGENTS.md](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#agentsmd)
    * [Directory Chain (git root → working directory)](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#directory-chain-git-root--working-directory)
    * [Progressive Subdirectory Discovery](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#progressive-subdirectory-discovery)
  * [How Context Files Are Loaded](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#how-context-files-are-loaded)
    * [At startup (system prompt)](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#at-startup-system-prompt)
    * [During the session (progressive discovery)](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#during-the-session-progressive-discovery)
  * [Security: Prompt Injection Protection](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#security-prompt-injection-protection)
  * [Tips for Effective Context Files](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#tips-for-effective-context-files)
    * [Per-Subdirectory Context](https://hermes-agent.nousresearch.com/docs/user-guide/features/context-files#per-subdirectory-context)
