...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#__docusaurus_skipToContent_fallback)
On this page
...
## Cached system prompt layers[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#cached-system-prompt-layers "Direct link to Cached system prompt layers")
...
### Concrete example: assembled system prompt[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#concrete-example-assembled-system-prompt "Direct link to Concrete example: assembled system prompt")
...
## Customizing platform hints[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#customizing-platform-hints "Direct link to Customizing platform hints")
...
## How SOUL.md appears in the prompt[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#how-soulmd-appears-in-the-prompt "Direct link to How SOUL.md appears in the prompt")
...
## How context files are injected[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#how-context-files-are-injected "Direct link to How context files are injected")
...
defbuild_context_files_prompt(cwd=None, skip_soul=False):
...
### Context file discovery details[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#context-file-discovery-details "Direct link to Context file discovery details")  
...
## API-call-time-only layers[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#api-call-time-only-layers "Direct link to API-call-time-only layers")
...
`pre_llm_call` plugin context also lands in this API-call-time path: it is appended to the current turn's **user message** , not written into the cached system prompt. When multiple plugins return context, Hermes concatenates those context blocks (see [Hooks → `pre_llm_call`](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks#pre_llm_call)).
This separation keeps the stable prefix stable for caching.
## Memory snapshots[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#memory-snapshots "Direct link to Memory snapshots")
...
## Context files[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#context-files "Direct link to Context files")
...
## Skills index[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#skills-index "Direct link to Skills index")
The skills system contributes a compact skills index to the prompt when skills tooling is available.
## Supported prompt customization surfaces[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#supported-prompt-customization-surfaces "Direct link to Supported prompt customization surfaces")
...
### Use these surfaces first[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#use-these-surfaces-first "Direct link to Use these surfaces first")
...
### When to edit code instead[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#when-to-edit-code-instead "Direct link to When to edit code instead")
...
## Why prompt assembly is split this way[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#why-prompt-assembly-is-split-this-way "Direct link to Why prompt assembly is split this way")
...
## Related docs[​](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#related-docs "Direct link to Related docs")
  ...
  * [Cached system prompt layers](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#cached-system-prompt-layers)
    * [Concrete example: assembled system prompt](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#concrete-example-assembled-system-prompt)
  * [Customizing platform hints](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#customizing-platform-hints)
  * [How SOUL.md appears in the prompt](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#how-soulmd-appears-in-the-prompt)
  * [How context files are injected](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#how-context-files-are-injected)
    * [Context file discovery details](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#context-file-discovery-details)
  * [API-call-time-only layers](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#api-call-time-only-layers)
  * [Supported prompt customization surfaces](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#supported-prompt-customization-surfaces)
    * [Use these surfaces first](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#use-these-surfaces-first)
    * [When to edit code instead](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#when-to-edit-code-instead)
  * [Why prompt assembly is split this way](https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly#why-prompt-assembly-is-split-this-way)
