...
## Overview[🔗](https://caddyserver.com/docs/automatic-https#overview "Link to this section")
...
## Activation[🔗](https://caddyserver.com/docs/automatic-https#activation "Link to this section")
...
## Effects[🔗](https://caddyserver.com/docs/automatic-https#effects "Link to this section")
...
## Hostname requirements[🔗](https://caddyserver.com/docs/automatic-https#hostname-requirements "Link to this section")
...
## Local HTTPS[🔗](https://caddyserver.com/docs/automatic-https#local-https "Link to this section")
...
### CA Root[🔗](https://caddyserver.com/docs/automatic-https#ca-root "Link to this section")
...
The first time a root key is used, Caddy will try to install it into the system's local trust store(s). If it does not have permission to do so, it will prompt for a password. This behavior can be disabled with [`skip_install_trust` in a caddyfile](https://caddyserver.com/docs/caddyfile/options#skip-install-trust) or [`"install_trust": false` in a json config](https://caddyserver.com/docs/json/apps/pki/certificate_authorities/install_trust/). If this fails due to being run as an unprivileged user, you may run [`caddy trust`](https://caddyserver.com/docs/command-line#caddy-trust) to retry installation as a privileged user.
...
### CA Intermediates[🔗](https://caddyserver.com/docs/automatic-https#ca-intermediates "Link to this section")
...
## Testing[🔗](https://caddyserver.com/docs/automatic-https#testing "Link to this section")
...
## ACME challenges[🔗](https://caddyserver.com/docs/automatic-https#acme-challenges "Link to this section")
...
### HTTP challenge[🔗](https://caddyserver.com/docs/automatic-https#http-challenge "Link to this section")
...
### TLS-ALPN challenge[🔗](https://caddyserver.com/docs/automatic-https#tls-alpn-challenge "Link to this section")
...
This challenge is enabled by default and does not require explicit configuration.
### DNS challenge[🔗](https://caddyserver.com/docs/automatic-https#dns-challenge "Link to this section")
...
## On-Demand TLS[🔗](https://caddyserver.com/docs/automatic-https#on-demand-tls "Link to this section")
...
### Using On-Demand TLS[🔗](https://caddyserver.com/docs/automatic-https#using-on-demand-tls "Link to this section")
...
## Errors[🔗](https://caddyserver.com/docs/automatic-https#errors "Link to this section")
...
### Issuer fallback[🔗](https://caddyserver.com/docs/automatic-https#issuer-fallback "Link to this section")
...
## Storage[🔗](https://caddyserver.com/docs/automatic-https#storage "Link to this section")
...
## Wildcard certificates[🔗](https://caddyserver.com/docs/automatic-https#wildcard-certificates "Link to this section")
...
**Note:** [Let's Encrypt requires ](https://letsencrypt.org/docs/challenge-types/) the [DNS challenge](https://caddyserver.com/docs/automatic-https#dns-challenge) to obtain wildcard certificates.
## Encrypted ClientHello (ECH)[🔗](https://caddyserver.com/docs/automatic-https#encrypted-clienthello-ech "Link to this section")
...
### Deployment considerations[🔗](https://caddyserver.com/docs/automatic-https#deployment-considerations "Link to this section")
...
#### Publication[🔗](https://caddyserver.com/docs/automatic-https#publication "Link to this section")
...
#### ECH GREASE[🔗](https://caddyserver.com/docs/automatic-https#ech-grease "Link to this section")
...
#### Key rotation[🔗](https://caddyserver.com/docs/automatic-https#key-rotation "Link to this section")
...
#### Public name[🔗](https://caddyserver.com/docs/automatic-https#public-name "Link to this section")
...
#### Anonymity set[🔗](https://caddyserver.com/docs/automatic-https#anonymity-set "Link to this section")
...
#### Centralization[🔗](https://caddyserver.com/docs/automatic-https#centralization "Link to this section")
...
#### Subdomain privacy[🔗](https://caddyserver.com/docs/automatic-https#subdomain-privacy "Link to this section")
...
### Enabling ECH[🔗](https://caddyserver.com/docs/automatic-https#enabling-ech "Link to this section")
...
### Verifying ECH[🔗](https://caddyserver.com/docs/automatic-https#verifying-ech "Link to this section")
...
### ECH in storage[🔗](https://caddyserver.com/docs/automatic-https#ech-in-storage "Link to this section")
