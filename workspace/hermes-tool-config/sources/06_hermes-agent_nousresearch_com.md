...
title: "Nous Tool Gateway | Hermes Agent"
...
## The enablement checklist[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#the-enablement-checklist "Direct link to The enablement checklist")
...
### One selection key per tool category[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#one-selection-key-per-tool-category "Direct link to One selection key per tool category")
...
### Switching back to your own keys[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#switching-back-to-your-own-keys "Direct link to Switching back to your own keys")
...
### Legacy `use_gateway` flag (deprecated)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#legacy-use_gateway-flag-deprecated "Direct link to legacy-use_gateway-flag-deprecated")
...
No — keep them in `.env`. While a tool's selection is **Nous Subscription** , direct keys for that tool are simply ignored. Pick the direct provider again in `hermes tools` and your keys become the source again. The gateway isn't a lock-in.
  * [The enablement checklist](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#the-enablement-checklist)
  ...
  * [Configuration reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#configuration-reference)
    * [One selection key per tool category](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#one-selection-key-per-tool-category)
    * [Switching back to your own keys](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#switching-back-to-your-own-keys)
    * [Legacy `use_gateway` flag (deprecated)](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway#legacy-use_gateway-flag-deprecated)
