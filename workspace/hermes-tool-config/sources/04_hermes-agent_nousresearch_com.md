...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#__docusaurus_skipToContent_fallback)
On this page
...
MCP Tools
In addition to built-in tools, Hermes can load tools dynamically from MCP servers. MCP tools appear with the prefix `mcp__<server>__` (e.g., `mcp__github__create_issue` for the `github` MCP server). See [MCP Integration](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp) for configuration.
##  `browser` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#browser-toolset "Direct link to browser-toolset")  
...
##  `browser` toolset (CDP-gated tools)[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#browser-toolset-cdp-gated-tools "Direct link to browser-toolset-cdp-gated-tools")
...
##  `clarify` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#clarify-toolset "Direct link to clarify-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
### Asking multiple questions at once[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#asking-multiple-questions-at-once "Direct link to Asking multiple questions at once")
...
##  `code_execution` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#code_execution-toolset "Direct link to code_execution-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `cronjob` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#cronjob-toolset "Direct link to cronjob-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `delegation` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#delegation-toolset "Direct link to delegation-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `feishu_doc` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#feishu_doc-toolset "Direct link to feishu_doc-toolset")
...
##  `feishu_drive` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#feishu_drive-toolset "Direct link to feishu_drive-toolset")
...
##  `file` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#file-toolset "Direct link to file-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `homeassistant` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#homeassistant-toolset "Direct link to homeassistant-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `computer_use` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#computer_use-toolset "Direct link to computer_use-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `image_gen` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#image_gen-toolset "Direct link to image_gen-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `project` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#project-toolset "Direct link to project-toolset")
Tools for driving desktop [Projects](https://hermes-agent.nousresearch.com/docs/user-guide/cli) — named, multi-folder workspaces. Registered when the `project` toolset is enabled (primarily the desktop app / dashboard surfaces).  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `memory` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#memory-toolset "Direct link to memory-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `session_search` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#session_search-toolset "Direct link to session_search-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `skills` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#skills-toolset "Direct link to skills-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `terminal` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#terminal-toolset "Direct link to terminal-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `desktop_ui` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#desktop_ui-toolset "Direct link to desktop_ui-toolset")
...
### Tours[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#tours "Direct link to Tours")
...
##  `todo` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#todo-toolset "Direct link to todo-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `vision` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#vision-toolset "Direct link to vision-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `video` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#video-toolset "Direct link to video-toolset")
...
##  `video_gen` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#video_gen-toolset "Direct link to video_gen-toolset")
...
##  `web` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#web-toolset "Direct link to web-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `x_search` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#x_search-toolset "Direct link to x_search-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `tts` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#tts-toolset "Direct link to tts-toolset")  
| Tool  | Description  | Requires environment  |  
| --- | --- | --- |  
...
##  `discord` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#discord-toolset "Direct link to discord-toolset")
...
##  `discord_admin` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#discord_admin-toolset "Direct link to discord_admin-toolset")
...
##  `spotify` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#spotify-toolset "Direct link to spotify-toolset")
...
##  `hermes-yuanbao` toolset[​](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#hermes-yuanbao-toolset "Direct link to hermes-yuanbao-toolset")
...
| `yb_send_sticker`  | Send a built-in sticker to the current Yuanbao chat.  | Yuanbao credentials  |  
  * [`browser` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#browser-toolset)
  * [`browser` toolset (CDP-gated tools)](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#browser-toolset-cdp-gated-tools)
  * [`clarify` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#clarify-toolset)
    * [Asking multiple questions at once](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#asking-multiple-questions-at-once)
  * [`code_execution` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#code_execution-toolset)
  * [`cronjob` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#cronjob-toolset)
  * [`delegation` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#delegation-toolset)
  * [`feishu_doc` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#feishu_doc-toolset)
  * [`feishu_drive` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#feishu_drive-toolset)
  * [`file` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#file-toolset)
  * [`homeassistant` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#homeassistant-toolset)
  * [`computer_use` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#computer_use-toolset)
  * [`image_gen` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#image_gen-toolset)
  * [`kanban` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#kanban-toolset)
  * [`project` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#project-toolset)
  * [`memory` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#memory-toolset)
  * [`session_search` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#session_search-toolset)
  * [`skills` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#skills-toolset)
  * [`terminal` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#terminal-toolset)
  * [`desktop_ui` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#desktop_ui-toolset)
  * [`todo` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#todo-toolset)
  * [`vision` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#vision-toolset)
  * [`video` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#video-toolset)
  * [`video_gen` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#video_gen-toolset)
  * [`web` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#web-toolset)
  * [`x_search` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#x_search-toolset)
  * [`tts` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#tts-toolset)
  * [`discord` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#discord-toolset)
  * [`discord_admin` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#discord_admin-toolset)
  * [`spotify` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#spotify-toolset)
  * [`hermes-yuanbao` toolset](https://hermes-agent.nousresearch.com/docs/reference/tools-reference#hermes-yuanbao-toolset)
