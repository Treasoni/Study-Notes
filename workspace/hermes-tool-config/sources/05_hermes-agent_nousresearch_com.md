...
| `MEM0_MODE`  | Mem0 backend mode: `platform` (default) or `oss` — see [Memory Providers](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory-providers)  |  
...
### Skill API Keys[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#skill-api-keys "Direct link to Skill API Keys")
...
## Egress proxy (sandbox-injected)[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#egress-proxy-sandbox-injected "Direct link to Egress proxy \(sandbox-injected\)")
...
| `HERMES_IRON_PROXY_NONCE`  | Set on the iron-proxy daemon process itself (NOT inside the sandbox). Used by `_pid_alive` to confirm a candidate PID still refers to _our_ managed binary across PID recycling.  |  
...
### Web Dashboard & Hermes Desktop[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#web-dashboard--hermes-desktop "Direct link to Web Dashboard & Hermes Desktop")
...
| `HERMES_DESKTOP_PYTHON`  | Absolute path to a Python interpreter for the backend, checked before Electron auto-resolves one for the source checkout. Used by worktree dev helpers (see [TUI & Desktop from Worktrees](https://hermes-agent.nousresearch.com/docs/developer-guide/worktree-ui-dev)) to reuse a shared venv.  |  
...
### IRC[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#irc "Direct link to IRC")
...
### SimpleX[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#simplex "Direct link to SimpleX")
...
### Photon[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#photon "Direct link to Photon")
...
### Buzz (Nostr communities)[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#buzz-nostr-communities "Direct link to Buzz \(Nostr communities\)")  
| Variable  | Description  |  
| --- | --- |  
...
### Microsoft Teams (adapter)[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#microsoft-teams-adapter "Direct link to Microsoft Teams \(adapter\)")
The Microsoft Teams platform adapter (Bot Framework / Azure AD), distinct from the [Microsoft Graph (Teams Meetings)](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#microsoft-graph-teams-meetings) integration above. See [the Teams messaging guide](https://hermes-agent.nousresearch.com/docs/user-guide/messaging/teams).  
| Variable  | Description  |  
| --- | --- |  
...
### Raft[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#raft "Direct link to Raft")  
| Variable  | Description  |  
| --- | --- |  
...
## NeMo Relay[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#nemo-relay "Direct link to NeMo Relay")  
| Variable  | Description  |  
| --- | --- |  
...
| `HERMES_WRITE_SAFE_ROOT`  | Optional directory prefix that **hard-blocks** `write_file`/`patch` writes outside the listed roots (no approval prompt). Supports multiple directories separated by `os.pathsep` (`:` on Unix, `;` on Windows). See [HERMES_WRITE_SAFE_ROOT](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#hermes_write_safe_root) below.  |  
...
### HERMES_WRITE_SAFE_ROOT[​](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#hermes_write_safe_root "Direct link to HERMES_WRITE_SAFE_ROOT")
...
exportHERMES_WRITE_SAFE_ROOT=/path/to/project:/home/you/.hermes


```

Unset the variable or remove it from `.env` to restore normal writes (still subject to the credential-path denylist — see [File write safety](https://hermes-agent.nousresearch.com/docs/user-guide/security#file-write-safety)).
...
Use `hermes config set` to set environment variables — it automatically saves them to the right file (`.env` for secrets, `config.yaml` for everything else).
  ...
  * [Egress proxy (sandbox-injected)](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#egress-proxy-sandbox-injected)
  * [Messaging](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#messaging)
    * [Web Dashboard & Hermes Desktop](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#web-dashboard--hermes-desktop)
    ...
    * [Buzz (Nostr communities)](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#buzz-nostr-communities)
    * [Microsoft Teams (adapter)](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#microsoft-teams-adapter)
  ...
  * [Agent Behavior](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#agent-behavior)
    * [HERMES_WRITE_SAFE_ROOT](https://hermes-agent.nousresearch.com/docs/reference/environment-variables#hermes_write_safe_root)
