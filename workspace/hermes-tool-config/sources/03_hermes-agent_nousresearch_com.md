...
The `mcpServers` block in your `~/.claude.json` maps to `mcp_servers` in Hermes' `config.yaml` — and `hermes import-agent claude-code` migrates it (along with skills and instructions) automatically. See [Import from Other Agents](https://hermes-agent.nousresearch.com/docs/user-guide/import-from-other-agents).
...
### Suggestion metadata (`suggest:`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#suggestion-metadata-suggest "Direct link to suggestion-metadata-suggest")
...
Hermes identifies itself with a [Client ID Metadata Document](https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference#client-identification-cimd-and-dcr) on servers that support one, and falls back to Dynamic Client Registration on those that don't. Both are automatic; there is nothing to configure.
Figma remote MCP
...
For fully headless gateways (messaging bot, no interactive terminal at all), the optional [`mcp-oauth-remote-gateway` skill](https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mcp/mcp-mcp-oauth-remote-gateway) walks the agent through completing the flow manually and writing tokens where Hermes expects them.
...
## mTLS / client certificates[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#mtls--client-certificates "Direct link to mTLS / client certificates")
...
## Per-user identity header[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#per-user-identity-header "Direct link to Per-user identity header")
...
### Recycling memory-heavy stdio servers[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#recycling-memory-heavy-stdio-servers "Direct link to Recycling memory-heavy stdio servers")
...
### Tool-result sanitization and `_meta`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#tool-result-sanitization-and-_meta "Direct link to tool-result-sanitization-and-_meta")
...
### Glob patterns[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#glob-patterns "Direct link to Glob patterns")
...
## MCP Elicitation Support[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#mcp-elicitation-support "Direct link to MCP Elicitation Support")
...
## Related docs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#related-docs "Direct link to Related docs")
  ...
  * [Catalog: one-click install for Nous-approved MCPs](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#catalog-one-click-install-for-nous-approved-mcps)
    ...
    * [Suggestion metadata (`suggest:`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#suggestion-metadata-suggest)
  ...
  * [mTLS / client certificates](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#mtls--client-certificates)
  * [Per-user identity header](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#per-user-identity-header)
  * [Basic configuration reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#basic-configuration-reference)
    ...
    * [Recycling memory-heavy stdio servers](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#recycling-memory-heavy-stdio-servers)
  ...
  * [How Hermes registers MCP tools](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#how-hermes-registers-mcp-tools)
    * [Tool-result sanitization and `_meta`](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#tool-result-sanitization-and-_meta)
  ...
  * [MCP Elicitation Support](https://hermes-agent.nousresearch.com/docs/user-guide/features/mcp#mcp-elicitation-support)
