...
> **笔记类型**：对比笔记 + 实战指南
> **来源**：官方文档（home-assistant.io 安装与部署章节、Supervised 要求）+ 技术博客 + 社区讨论（Home Assistant 社区论坛、Reddit），交叉验证；文中「素材 §X.Y」指向 `02_deep_research.md` 对应小节

## 目录

1. [第一章：三种部署方式全景](#第一章三种部署方式全景)
2. [第二章：核心对比表](#第二章核心对比表)
3. [第三章：HAOS 虚拟机详解](#第三章haos虚拟机详解)
...
下一章给出十维对比总表，把三种方式在功能、维护、资源上的差异一次看清。
