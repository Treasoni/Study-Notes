---
url: "https://containerd.io/docs/1.7/hosts/"
title: "containerd docs – Hosts"
scraped_at: 2026-09-13T16:04:45+00:00
---

[Downloads](https://containerd.io/downloads)
[Docs](https://containerd.io/docs/2.3/)
Project
[Code of conduct](https://github.com/cncf/foundation/blob/master/code-of-conduct.md) [Collaboration with Kubernetes SIG-Node](https://containerd.io/keps/) [Contributing](https://containerd.io/contributing/) [Roadmap](https://containerd.io/roadmap/) [Scope and principles](https://containerd.io/scope/) [Security and audits](https://containerd.io/security/) [Versioning and release](https://containerd.io/releases/) [containerd branding](https://github.com/cncf/artwork/blob/master/examples/graduated.md#containerd-logos)
Hosts
Version: 1.7
Docs
[README](https://containerd.io/docs/1.7/) [Client Opts](https://containerd.io/docs/1.7/client-opts/) [Content Flow](https://containerd.io/docs/1.7/content-flow/) [CRI: Architecture](https://containerd.io/docs/1.7/cri/architecture/) [CRI: Config](https://containerd.io/docs/1.7/cri/config/) [CRI: crictl](https://containerd.io/docs/1.7/cri/crictl/) [CRI: Decryption](https://containerd.io/docs/1.7/cri/decryption/) [CRI: Installation](https://containerd.io/docs/1.7/cri/installation/) [CRI: Registry](https://containerd.io/docs/1.7/cri/registry/) [CRI: Testing](https://containerd.io/docs/1.7/cri/testing/) [Garbage Collection](https://containerd.io/docs/1.7/garbage-collection/) [Getting Started](https://containerd.io/docs/1.7/getting-started/) [Hosts](https://containerd.io/docs/1.7/hosts/) [Manual pages: containerd-config(8)](https://containerd.io/docs/1.7/man/containerd-config.8/) [Manual pages: containerd-config.toml(5)](https://containerd.io/docs/1.7/man/containerd-config.toml.5/) [Managed Opt](https://containerd.io/docs/1.7/managed-opt/) [Namespaces](https://containerd.io/docs/1.7/namespaces/) [NRI](https://containerd.io/docs/1.7/nri/) [Ops](https://containerd.io/docs/1.7/ops/) [Plugins](https://containerd.io/docs/1.7/plugins/) [Remote Snapshotter](https://containerd.io/docs/1.7/remote-snapshotter/) [Rootless](https://containerd.io/docs/1.7/rootless/) [runc](https://containerd.io/docs/1.7/runc/) [Snapshotters: Devmapper](https://containerd.io/docs/1.7/snapshotters/devmapper/) [Snapshotters: README](https://containerd.io/docs/1.7/snapshotters/readme/) [Stream Processors](https://containerd.io/docs/1.7/stream_processors/) [Tracing](https://containerd.io/docs/1.7/tracing/) [Transfer](https://containerd.io/docs/1.7/transfer/)
Contents
...
Currently supported OCI Distribution version: 
...
Project
  * [Collaboration with Kubernetes SIG-Node](https://containerd.io/keps/)
  * [Scope and principles](https://containerd.io/scope/)
  * [Security and audits](https://containerd.io/security/)
  * [Versioning and release](https://containerd.io/releases/)


Community
[ GitHub](https://github.com/containerd/containerd) [ Slack](https://slack.containerd.io/) [ Bluesky](https://bsky.app/profile/containerd.dev) [ Mastodon](https://hachyderm.io/@containerd) [ Twitter](https://twitter.com/@containerd) [ YouTube](https://www.youtube.com/@CNCFcontainerd)
© containerd Authors 2026 | Documentation Distributed under [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/)
