...
[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#__docusaurus_skipToContent_fallback)
On this page
...
## Single Task[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#single-task "Direct link to Single Task")
...
## Parallel Batch[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#parallel-batch "Direct link to Parallel Batch")
...
## How Subagent Context Works[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#how-subagent-context-works "Direct link to How Subagent Context Works")
...
## Practical Examples[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#practical-examples "Direct link to Practical Examples")
### Parallel Research[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#parallel-research "Direct link to Parallel Research")
...
### Code Review + Fix[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#code-review--fix "Direct link to Code Review + Fix")
...
### Multi-File Refactoring[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#multi-file-refactoring "Direct link to Multi-File Refactoring")
...
## Batch Mode Details[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#batch-mode-details "Direct link to Batch Mode Details")
...
### Durable background completions[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#durable-background-completions "Direct link to Durable background completions")
...
### Child background-process notifications[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#child-background-process-notifications "Direct link to Child background-process notifications")
...
## Model Override[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#model-override "Direct link to Model Override")
...
### Cost strategy: frontier planner, inexpensive workers[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#cost-strategy-frontier-planner-inexpensive-workers "Direct link to Cost strategy: frontier planner, inexpensive workers")
...
Note that the pin is global: `delegate_task` has no per-task model parameter, so every child in a batch runs on the configured delegation model. For quality-sensitive subtasks that need a stronger model, either leave `delegation.model` unset for that session or hand the task to the [kanban board](https://hermes-agent.nousresearch.com/docs/user-guide/features/kanban#per-task-model-override), which does support a per-task model override.
## The `/review` Command[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#the-review-command "Direct link to the-review-command")
...
### Review model[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#review-model "Direct link to Review model")
...
## Inherited Tool Access[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#inherited-tool-access "Direct link to Inherited Tool Access")
...
Certain tools are blocked for subagents even when the parent has them:
  * `delegate_task` — blocked for leaf subagents (the default). Retained for `role="orchestrator"` children, bounded by `max_spawn_depth` — see [Depth Limit and Nested Orchestration](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#depth-limit-and-nested-orchestration) below.
...
## Max Iterations[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#max-iterations "Direct link to Max Iterations")
...
## Child Timeout[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#child-timeout "Direct link to Child Timeout")
...
## Stall Detection for Background Subagents[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#stall-detection-for-background-subagents "Direct link to Stall Detection for Background Subagents")
...
## Monitoring Running Subagents (`/agents`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#monitoring-running-subagents-agents "Direct link to monitoring-running-subagents-agents")
...
The classic CLI just prints `/agents` as a text summary; the TUI is where the overlay shines. See [TUI — Slash commands](https://hermes-agent.nousresearch.com/docs/user-guide/tui#slash-commands).
...
## Steering a Running Subagent[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#steering-a-running-subagent "Direct link to Steering a Running Subagent")
Interrupting a child throws away its in-flight work; often you just want to redirect it.
### From the parent agent (model-facing)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#from-the-parent-agent-model-facing "Direct link to From the parent agent \(model-facing\)")
...
### From the TUI / gateway (session-facing)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#from-the-tui--gateway-session-facing "Direct link to From the TUI / gateway \(session-facing\)")
...
## Live Transcripts[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#live-transcripts "Direct link to Live Transcripts")
...
## Depth Limit and Nested Orchestration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#depth-limit-and-nested-orchestration "Direct link to Depth Limit and Nested Orchestration")
...
## Lifetime and Durability[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#lifetime-and-durability "Direct link to Lifetime and Durability")
...
## Key Properties[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#key-properties "Direct link to Key Properties")
...
## Worktree Isolation[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#worktree-isolation "Direct link to Worktree Isolation")
...
## Delegation vs execute_code[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#delegation-vs-execute_code "Direct link to Delegation vs execute_code")  
...
## Configuration[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#configuration "Direct link to Configuration")
...
The agent handles delegation automatically based on the task complexity. You don't need to explicitly ask it to delegate — it will do so when it makes sense.
  * [How Subagent Context Works](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#how-subagent-context-works)
  * [Practical Examples](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#practical-examples)
    * [Multi-File Refactoring](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#multi-file-refactoring)
  * [Batch Mode Details](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#batch-mode-details)
    * [Durable background completions](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#durable-background-completions)
    * [Child background-process notifications](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#child-background-process-notifications)
  * [Model Override](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#model-override)
    * [Cost strategy: frontier planner, inexpensive workers](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#cost-strategy-frontier-planner-inexpensive-workers)
  * [The `/review` Command](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#the-review-command)
  * [Inherited Tool Access](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#inherited-tool-access)
  * [Stall Detection for Background Subagents](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#stall-detection-for-background-subagents)
  * [Monitoring Running Subagents (`/agents`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#monitoring-running-subagents-agents)
  * [Steering a Running Subagent](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#steering-a-running-subagent)
    * [From the parent agent (model-facing)](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#from-the-parent-agent-model-facing)
    * [From the TUI / gateway (session-facing)](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#from-the-tui--gateway-session-facing)
  * [Depth Limit and Nested Orchestration](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#depth-limit-and-nested-orchestration)
  * [Lifetime and Durability](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#lifetime-and-durability)
  * [Delegation vs execute_code](https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation#delegation-vs-execute_code)
