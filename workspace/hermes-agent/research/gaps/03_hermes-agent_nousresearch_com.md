...
### Deliver media as documents (`[[as_document]]`)[​](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#deliver-media-as-documents-as_document "Direct link to deliver-media-as-documents-as_document")
If your skill produces a high-resolution screenshot, chart, or any image where lossy preview compression would hurt — emit the literal directive `[[as_document]]` somewhere in the response (commonly the last line). The gateway strips the directive and delivers every extracted media path in that response as a downloadable file attachment instead of an inline image bubble. See [Skill output and media delivery](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills#skill-output-and-media-delivery) for the full semantics.
...
## Blueprints: skills that are also automations[​](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#blueprints-skills-that-are-also-automations "Direct link to Blueprints: skills that are also automations")
...
Blueprints are one **source** of the unified Suggested Cron Jobs surface — the same place curated starter automations and (later) usage-pattern and integration suggestions appear. See [Suggested Cron Jobs](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#suggested-cron-jobs) below.
...
## Suggested Cron Jobs[​](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#suggested-cron-jobs "Direct link to Suggested Cron Jobs")
...
If you want your skills to be discoverable without a GitHub-specific installer, consider serving them from a well-known endpoint in addition to publishing them in a repo or marketplace.
  ...
  * [Skill Guidelines](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#skill-guidelines)
    ...
    * [Deliver media as documents (`[[as_document]]`)](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#deliver-media-as-documents-as_document)
  ...
  * [Blueprints: skills that are also automations](https://hermes-agent.nousresearch.com/docs/developer-guide/creating-skills#blueprints-skills-that-are-also-automations)
