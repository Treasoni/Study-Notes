...
## Pre-dispatch configuration validation[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#pre-dispatch-configuration-validation "Direct link to Pre-dispatch configuration validation")
...
## Letting unpinned jobs track global defaults[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#letting-unpinned-jobs-track-global-defaults "Direct link to Letting unpinned jobs track global defaults")
...
## Agent-managed scheduling (cron jobs that manage cron jobs)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#agent-managed-scheduling-cron-jobs-that-manage-cron-jobs "Direct link to Agent-managed scheduling \(cron jobs that manage cron jobs\)")
...
### Execution history[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#execution-history "Direct link to Execution history")
...
### Repeated-failure review nudge[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#repeated-failure-review-nudge "Direct link to Repeated-failure review nudge")
...
### Failure incidents: acknowledge a known failure[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#failure-incidents-acknowledge-a-known-failure "Direct link to Failure incidents: acknowledge a known failure")
...
### Bot Chat delivery (`bot-chat`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#bot-chat-delivery-bot-chat "Direct link to bot-chat-delivery-bot-chat")
...
### Continuable jobs (reply to a cron delivery)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#continuable-jobs-reply-to-a-cron-delivery "Direct link to Continuable jobs \(reply to a cron delivery\)")
...
#### Flat, in-channel continuation (Slack)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#flat-in-channel-continuation-slack "Direct link to Flat, in-channel continuation \(Slack\)")
...
## Media send timeout[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#media-send-timeout "Direct link to Media send timeout")
...
## Bot Chat delivery timeout[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#bot-chat-delivery-timeout "Direct link to Bot Chat delivery timeout")
...
## Missed scheduled fires (`last_fire_error`)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#missed-scheduled-fires-last_fire_error "Direct link to missed-scheduled-fires-last_fire_error")
...
### Misfire catch-up[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#misfire-catch-up "Direct link to Misfire catch-up")
...
### Manual runs are asynchronous[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#manual-runs-are-asynchronous "Direct link to Manual runs are asynchronous")
...
test-f"$FEED"||{echo'{"wakeAgent": false}';exit0;}
...
last=$(cat"$STATE"2/dev/null ||echo0)
...
iftest-f /tmp/new-data-ready;then
...
Job definitions are plain JSON on disk: they survive `hermes update`, gateway restarts, and machine reboots. A job that was mid-run during a restart is marked `unknown` in the execution ledger — it is not automatically retried, but the job's next scheduled tick fires normally. See [Execution history](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#execution-history) for details.
tip
Ask the agent to manage jobs through the `cronjob` tool, `hermes cron edit`, or `/cron` — not by patching `jobs.json` directly. Direct edits can fail silently when [file write safety](https://hermes-agent.nousresearch.com/docs/user-guide/security#file-write-safety) blocks the path (for example when `HERMES_WRITE_SAFE_ROOT` is set), and the [file-mutation verifier](https://hermes-agent.nousresearch.com/docs/user-guide/configuration#file-mutation-verifier) footer is the authoritative signal that nothing was saved.
...
Scheduled task prompts are scanned for prompt-injection and credential-exfiltration patterns at creation and update time. Prompts containing invisible Unicode tricks, SSH backdoor attempts, or obvious secret-exfiltration payloads are blocked.
  ...
  * [Pre-dispatch configuration validation](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#pre-dispatch-configuration-validation)
  * [Letting unpinned jobs track global defaults](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#letting-unpinned-jobs-track-global-defaults)
  ...
  * [Agent-managed scheduling (cron jobs that manage cron jobs)](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#agent-managed-scheduling-cron-jobs-that-manage-cron-jobs)
  * [How it works](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#how-it-works)
    ...
    * [Repeated-failure review nudge](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#repeated-failure-review-nudge)
    * [Failure incidents: acknowledge a known failure](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#failure-incidents-acknowledge-a-known-failure)
  * [Delivery options](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#delivery-options)
    * [Bot Chat delivery (`bot-chat`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#bot-chat-delivery-bot-chat)
    ...
    * [Continuable jobs (reply to a cron delivery)](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#continuable-jobs-reply-to-a-cron-delivery)
  * [Bot Chat delivery timeout](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#bot-chat-delivery-timeout)
  ...
  * [Missed scheduled fires (`last_fire_error`)](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#missed-scheduled-fires-last_fire_error)
  ...
  * [Managing jobs programmatically](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#managing-jobs-programmatically)
    * [Manual runs are asynchronous](https://hermes-agent.nousresearch.com/docs/user-guide/features/cron#manual-runs-are-asynchronous)
