...
scraped_at: 2026-08-27T16:25:51+00:00
---

[Skip to main content](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#__docusaurus_skipToContent_fallback)
On this page
...
## Architecture[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#architecture "Direct link to Architecture")
### Two-Layer Context Injection[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#two-layer-context-injection "Direct link to Two-Layer Context Injection")
...
### Cold/Warm Prompt Selection[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#coldwarm-prompt-selection "Direct link to Cold/Warm Prompt Selection")
...
### Three Orthogonal Config Knobs[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#three-orthogonal-config-knobs "Direct link to Three Orthogonal Config Knobs")
Cost and depth are controlled by three independent knobs:  
| Knob  | Controls  | Default  |  
| --- | --- | --- |  
| `contextCadence`  | Turns between `context()` API calls (base layer refresh)  |  
| `dialecticCadence`  | Turns between `peer.chat()` LLM calls (dialectic layer refresh)  |  `2` (recommended 1–5)  |  
| `dialecticDepth`  | Number of `.chat()` passes per dialectic invocation (1–3)  |  
...
### Dialectic Depth (Multi-Pass)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#dialectic-depth-multi-pass "Direct link to Dialectic Depth \(Multi-Pass\)")
...
### Session-Start Prewarm[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#session-start-prewarm "Direct link to Session-Start Prewarm")
...
### Query-Adaptive Reasoning Level[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#query-adaptive-reasoning-level "Direct link to Query-Adaptive Reasoning Level")
...
## Configuration Options[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#configuration-options "Direct link to Configuration Options")
...
### Self-Hosted Honcho with Authentication[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#self-hosted-honcho-with-authentication "Direct link to Self-Hosted Honcho with Authentication")
...
### Full Config Reference[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#full-config-reference "Direct link to Full Config Reference")  
...
| `contextCadence`  | Minimum turns between `context()` API calls (base layer refresh)  |  
| `dialecticCadence`  | Minimum turns between `peer.chat()` LLM calls (dialectic layer). Recommended 1–5. In `tools` mode, irrelevant — model calls explicitly  |  
| `dialecticDepth`  | Number of `.chat()` passes per dialectic invocation. Clamped to 1–3  |  
...
## Gateway Identity Mapping[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#gateway-identity-mapping "Direct link to Gateway Identity Mapping")
These settings only matter when you run the [Hermes gateway](https://hermes-agent.nousresearch.com/docs/developer-guide/gateway-internals) — the one entrypoint where users arrive with platform-native runtime IDs (Telegram UID, Discord snowflake, Slack user). CLI, TUI, and desktop sessions have no runtime ID and always resolve to `peerName`, so off-gateway these keys do nothing.
...
## Observation (Directional vs. Unified)[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#observation-directional-vs-unified "Direct link to Observation \(Directional vs. Unified\)")
...
## Tools[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#tools "Direct link to Tools")
...
## CLI Commands[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#cli-commands "Direct link to CLI Commands")
...
## Migrating from `hermes honcho`[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#migrating-from-hermes-honcho "Direct link to migrating-from-hermes-honcho")
...
## Full Documentation[​](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#full-documentation "Direct link to Full Documentation")
See [Memory Providers — Honcho](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory-providers#honcho) for the complete reference.
  * [Architecture](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#architecture)
    * [Two-Layer Context Injection](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#two-layer-context-injection)
    * [Cold/Warm Prompt Selection](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#coldwarm-prompt-selection)
    * [Three Orthogonal Config Knobs](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#three-orthogonal-config-knobs)
    * [Dialectic Depth (Multi-Pass)](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#dialectic-depth-multi-pass)
    * [Session-Start Prewarm](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#session-start-prewarm)
    * [Query-Adaptive Reasoning Level](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#query-adaptive-reasoning-level)
  * [Configuration Options](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#configuration-options)
    * [Self-Hosted Honcho with Authentication](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#self-hosted-honcho-with-authentication)
    * [Full Config Reference](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#full-config-reference)
  * [Gateway Identity Mapping](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#gateway-identity-mapping)
  * [Observation (Directional vs. Unified)](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#observation-directional-vs-unified)
  * [Migrating from `hermes honcho`](https://hermes-agent.nousresearch.com/docs/user-guide/features/honcho#migrating-from-hermes-honcho)
