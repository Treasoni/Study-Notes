...
run_id: "tailscale-subnet-router-fnos"
task: "fnOS Docker 部署 Tailscale 子网路由器（Subnet Router）实战教程"
created_from: ".claude/workflows/learning-note-flow/state-template.md"
topic: "fnOS Docker 部署 Tailscale 子网路由器（Subnet Router）实战教程"
...
- **笔记类型**：实战笔记（上手）
- **总字数**：约 18,000 字符（6 章正文约 16,570 汉字 + 引言/目录/过渡语/总结）
- **章节数**：6
