...
run_id: "git-branch-worktree"
task: "git branch 与 worktree 的区别、使用场景，以及 AI 开发项目时该用哪个（实战笔记）"
created_from: ".claude/workflows/learning-note-flow/state-template.md"
topic: "git branch 与 worktree 的区别、使用场景，以及 AI 开发项目时该用哪个（实战笔记）"
project_slug: "git-branch-worktree"
depth: 上手
level: 有了解
purpose: 实战
...
> 主题：git branch 与 worktree 的区别、使用场景，以及 AI 开发项目时该用哪个（实战笔记）
