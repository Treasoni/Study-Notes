...
title: "Invoking iperf3 — iperf3 3.21 documentation"
scraped_at: 2026-08-27T14:52:14+00:00
---

  * [Section ](https://software.es.net/iperf/index.html)
      * [iperf3 Project News](https://software.es.net/iperf/news.html)
      * [iperf3 Development](https://software.es.net/iperf/dev.html)
  * [ Building iperf3  ](https://software.es.net/iperf/building.html "Previous Chapter: Building iperf3")
  * [ iperf3 Development  ](https://software.es.net/iperf/dev.html "Next Chapter: iperf3 Development")


  * [Invoking iperf3](https://software.es.net/iperf/invoking.html)
    * [iperf3 Manual Page](https://software.es.net/iperf/invoking.html#iperf3-manual-page)


# Invoking iperf3[¶](https://software.es.net/iperf/invoking.html#invoking-iperf3 "Link to this heading")
