---
url: "https://tailscale.com/blog/peer-relays-international-networks"
title: "Using Tailscale's Peer Relays to fix a homelab connection from across the globe"
scraped_at: 2026-08-27T14:52:14+00:00
---

[Border0 + Tailscale is now Tailscale PAM.Beta sign-up →](https://tailscale.com/pam-selfserve-waitlist)
[Blog](https://tailscale.com/blog)|insights一月 26, 2026
...
## [The problem: DERP across oceans](https://tailscale.com/blog/peer-relays-international-networks#the-problem-derp-across-oceans)
...
_iperf3 TCP throughput test from Delhi to Robbinsdale over DERP. The wildly variable sender bitrate reflects DERP QoS shaping on the connection. The receiver total (31.5 MB over 120 seconds) tells the real story: ~2.2 Mbits/sec sustained._
...
## [Why direct connections failed](https://tailscale.com/blog/peer-relays-international-networks#why-direct-connections-failed)
...
### [What bad looks like](https://tailscale.com/blog/peer-relays-international-networks#what-bad-looks-like)
...
### [Diagnosing your NAT situation](https://tailscale.com/blog/peer-relays-international-networks#diagnosing-your-nat-situation)
...
#### [Detect NAT type with Stunner](https://tailscale.com/blog/peer-relays-international-networks#detect-nat-type-with-stunner)
...
#### [Tailscale's built-in diagnostics](https://tailscale.com/blog/peer-relays-international-networks#tailscales-built-in-diagnostics)
...
#### [Check connection path with tailscale ping](https://tailscale.com/blog/peer-relays-international-networks#check-connection-path-with-tailscale-ping)
...
## [The Solution: Tailscale Peer Relays](https://tailscale.com/blog/peer-relays-international-networks#the-solution-tailscale-peer-relays)
...
### [How peer relays work](https://tailscale.com/blog/peer-relays-international-networks#how-peer-relays-work)
...
## [Setting up peer relays](https://tailscale.com/blog/peer-relays-international-networks#setting-up-peer-relays)
...
## [The results: 12.5x improvement](https://tailscale.com/blog/peer-relays-international-networks#the-results-125x-improvement)
...
_Same test, same location, peer relays enabled. Throughput stabilizes at 27-35 Mbits/sec, a 12.5x improvement over DERP._
### [Results comparison](https://tailscale.com/blog/peer-relays-international-networks#results-comparison)
_The peer relay test showed consistent 27-35 Mbits/sec, with no sustained dropout periods._
### [Verifying peer relay connectivity](https://tailscale.com/blog/peer-relays-international-networks#verifying-peer-relay-connectivity)
...
### [Understanding the baseline latency](https://tailscale.com/blog/peer-relays-international-networks#understanding-the-baseline-latency)
...
## [Conclusion](https://tailscale.com/blog/peer-relays-international-networks#conclusion)
