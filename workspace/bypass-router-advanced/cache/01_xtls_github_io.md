---
url: "https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html"
title: "透明代理入门 | Project X"
scraped_at: 2026-09-23T06:05:19+00:00
---

[Skip to content](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#VPContent)
页面导航
# 透明代理入门 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86%E5%85%A5%E9%97%A8)
## 什么是透明代理 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E4%BB%80%E4%B9%88%E6%98%AF%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86)
...
## 透明代理的实现 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86%E7%9A%84%E5%AE%9E%E7%8E%B0)
透明代理的实现目前主要有两种方式：
### tun2socks [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#tun2socks)
可用 Windows/Linux(包括安卓)实现。因为实现过程比较简单，很少有教程，我这里简单描述一下。
**Windows**
  1. 安装 ，使用模式`[3] [TUN/TAP] 绕过局域网`启动。
  2. 开启热点
...
### iptables/nftables [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#iptables-nftables)
...
现存的三篇白话文透明代理教程其实讲的都是基于这种方案的透明代理实现，它们是： **[新 V2Ray 白话文指南-透明代理](https://guide.v2fly.org/app/transparent_proxy.html)** 、 **[新 V2Ray 白话文指南-透明代理(TPROXY)](https://guide.v2fly.org/app/tproxy.html)** 、 **[透明代理（TProxy）配置教程](https://xtls.github.io/document/level-2/tproxy.html)** 。其中第一篇是基于 iptables-redirect 模式，已经过时了，不建议使用，仅供参考。第二篇和第三篇讲的都是基于 iptables-tproxy 模式的透明代理实现。
## iptables 实现透明代理原理 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#iptables-%E5%AE%9E%E7%8E%B0%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86%E5%8E%9F%E7%90%86)
...
## 透明代理难在哪里 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86%E9%9A%BE%E5%9C%A8%E5%93%AA%E9%87%8C)
...
## 从零开始一步步实现基于 iptables-tproxy 的透明代理 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E4%BB%8E%E9%9B%B6%E5%BC%80%E5%A7%8B%E4%B8%80%E6%AD%A5%E6%AD%A5%E5%AE%9E%E7%8E%B0%E5%9F%BA%E4%BA%8E-iptables-tproxy-%E7%9A%84%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86)
### 在开始之前，你需要有一定的基础知识： [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E5%9C%A8%E5%BC%80%E5%A7%8B%E4%B9%8B%E5%89%8D-%E4%BD%A0%E9%9C%80%E8%A6%81%E6%9C%89%E4%B8%80%E5%AE%9A%E7%9A%84%E5%9F%BA%E7%A1%80%E7%9F%A5%E8%AF%86)
...
### 前期准备工作 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E5%89%8D%E6%9C%9F%E5%87%86%E5%A4%87%E5%B7%A5%E4%BD%9C)
WARNING
...
### 首先，我们先试试做到第一阶段 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E9%A6%96%E5%85%88-%E6%88%91%E4%BB%AC%E5%85%88%E8%AF%95%E8%AF%95%E5%81%9A%E5%88%B0%E7%AC%AC%E4%B8%80%E9%98%B6%E6%AE%B5)
WARNING
...
### 第二阶段 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E7%AC%AC%E4%BA%8C%E9%98%B6%E6%AE%B5)
重启网关，运行 Xray，执行以下指令：
bash
```
ip rule add fwmark 1 table 100
...
### 第三阶段 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E7%AC%AC%E4%B8%89%E9%98%B6%E6%AE%B5)
...
### 第四阶段 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E7%AC%AC%E5%9B%9B%E9%98%B6%E6%AE%B5)
...
### 代理 ipv6 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#%E4%BB%A3%E7%90%86-ipv6)
上面的规则只对 ipv4 生效，如果还想要代理 ipv6 请求，则使用 ip6tables 命令，用法与 iptables 基本相同。参考 **[[透明代理]通过 gid 规避 Xray 流量#4-设置 iptables 规则](https://xtls.github.io/document/level-2/iptables_gid.html#_4-%E8%AE%BE%E7%BD%AEiptables%E8%A7%84%E5%88%99-md)**
# iptables 透明代理的其它注意事项 [​](https://xtls.github.io/document/level-2/transparent_proxy/transparent_proxy.html#iptables-%E9%80%8F%E6%98%8E%E4%BB%A3%E7%90%86%E7%9A%84%E5%85%B6%E5%AE%83%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9)
  ...
  2. **[新 V2Ray 白话文指南-透明代理(TPROXY)#设置网关](https://guide.v2fly.org/app/tproxy.html#%E8%AE%BE%E7%BD%AE%E7%BD%91%E5%85%B3)** 中的第三条说：`手动配置 PC 的网络，将默认网关指向树莓派的地址即 192.168.1.22。此时 PC 应当能正常上网（由于还没设置代理，“正常”是指可以上国内的网站）`。实际上，Ubuntu、CentOS、debian 等系统就算开启了 IP 转发，PC 也不能正常上网，这是正常的。事实上只有 OpenWRT 能做到文中所描述的那样，据 点拨，这是由于一般的 Linux 系统没有 Masquery 规则。
  3. ，解决方法见 **[[透明代理]通过 gid 规避 Xray 流量-配置最大文件大开数&运行 Xray 客户端](https://xtls.github.io/document/level-2/iptables_gid.html#_3-%E9%85%8D%E7%BD%AE%E6%9C%80%E5%A4%A7%E6%96%87%E4%BB%B6%E5%A4%A7%E5%BC%80%E6%95%B0%E8%BF%90%E8%A1%8Cxray%E5%AE%A2%E6%88%B7%E7%AB%AF)**
