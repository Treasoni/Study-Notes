...
| 主题 | 内容 | 韥看 |
|------|------|------|
| [[#常见分支模型]] | GitHub Flow / Git Flow / Trunk-Based | ⭐⭐ |
| [[#分支命名规范]] | 匉类型命名 | ⭐ |
| [[#分支生命周期管理]] | 创建、开发、完成、 ⭐⭐ |
| [[#团队协作工作流]] | 日常开发、 Code review | ⭐⭐ |
| [[#避免冲突的技巧]] | 预防和解决冲突 | ⭐⭐ |
| [[#常见问题]] | Q&A | ⭐⭐⭐ |
| [[#相关文档]] | 扩展阅读 | ⭐ |
...
> 🎯 **最适合场景**: 有明确发布周期的项目、 需要维护多个版本、 大型团队

### 分支结构

```mermaid
flowchart TB
    A[main<br>生产环境] --> B[develop<br>开发集成]
    B --> C[feature/*<br>功能开发]
    B --> D[release/*<br>发布准备]
    D --> A
    A --> E[hotfix/*<br>紧急修复]
...
> 🎯 **最适合场景**: 大型互联网公司、 有完善自动化测试的团队、 微服务架构
...
|--------|----------|
| | Git 知识体系索引 | [[Git MOC]] |
| | 分支操作基础 | [[Git 入门教程#6-分支管理]] |
| | 冲突解决详细步骤 | ~~Git 常见错误解决方案~~ *(已删除)* |
| | Rebase 使用技巧 | [[Git 高级技巧#1-rebase-变基]] |
| | 咽速查找命令 | [[Git 命令速查]] |
| | Pro Git 电子书 | https://git-scm.com/book/zh/v2 |
| | Atlassian Git 教程 | https://www.atlassian.com/git/tutorials |
| | Atlassian Git Cheatsheet | https://www.atlassian.com/dam/jch/blog/git-cheatsheet |
```
---
