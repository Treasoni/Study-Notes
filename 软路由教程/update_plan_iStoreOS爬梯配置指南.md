...
| §4.6 已知问题 | iStoreOS 24.10.7 升级冲突 | 24.10.8 升级冲突；自启 Bug 改为「升级观察」表述 | 更新日志 |

### 需要删除

- **§3.1.2 / §4.2「通过 iStore 安装」**：官方 iStore 商店默认不含代理插件，搜索安装流程在官方固件上走不通，整节删除（保留 Passwall vs Passwall2 提示，移至 §3.1.2 开头）
