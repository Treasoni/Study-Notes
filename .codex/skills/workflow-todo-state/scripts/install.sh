...
Options:
  ...
  --agent-dir DIR   Agent configuration directory in the target project (default: .codex).
  --skills-dir DIR  Skill installation directory (default: <agent-dir>/skills; Codex profile: .agents/skills).
  --entry-file FILE Project instruction file to update (default: CLAUDE.md for the historical .codex profile).
...
load_profile() {
  ...
  case "$name" in
    codex)
      ...
      ;;
    claude)
      AGENT_DIR=".codex"; SKILLS_DIR=".codex/skills"; RULES_DIR=".codex/rules"; SCRIPTS_DIR=".codex/scripts"; WORKFLOWS_DIR=".codex/workflows"; ENTRY_FILE="CLAUDE.md"
      ;;
    generic)
