...
用法:
    python3 .codex/skills/sync-skill-registry/scripts/sync_skill_registry.py
...
SCRIPT_DERIVED_SKILL_DIR = pathlib.Path(__file__).resolve().parent.parent.parent  # e.g. .codex/skills/
