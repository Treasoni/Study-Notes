...
```bash
python3 .codex/skills/maintain-learnings/scripts/audit_learnings.py --root . --skills-dir .codex/skills --rules-file CLAUDE.md --hooks-path .codex/hooks
```
...
- hook 问题：`.codex/hooks/` / `.codex/hooks/` / 项目自定义 hook
- 工具脚本问题：对应 `scripts/`
