...
> 原文链接: https://www.langchain.com/blog/the-anatomy-of-an-agent-harness

---

[Agent Architecture](/blog?category_equal=%5B%22Agent+Architecture%22%5D)
...
](#why-do-we-need-harnesses-from-a-models-perspective)
...
](#sandboxes-and-tools-to-execute-and-verify-work)
...
[](/blog/tuning-deep-agents-different-models)
...
[](/blog/langsmith-langchain-oss-eu-ai-act)
