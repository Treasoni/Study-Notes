---
title: "第一章：为什么是 Docker 版 —— 部署架构与能力边界"
tags:
  - Home-Assistant
  - Docker
  - HACS
...
「第一章」 ｜ [[02_快速起跑_docker-run部署与config目录结构.md|第二章 · 快速起跑 →]]
...
[^research-a1]: Supervised 弃用：跑 Portainer/Watchtower 等运维工具会被标 Unsupported/Unhealthy。
[^research-synthesis]: Docker Container 版 = 无 Supervisor 的单容器，无 Add-on Store、ha CLI、内置备份，伴生服务用独立容器自管。
