...
> 前置关联：[[Home Assistant 三种部署方式对比与选型.md]]、[[_part03#第四章 无头 onboarding：让 HA 首次启动不再需要浏览器|第四章 无头 onboarding]]、[[_part04#第七章 场景模板与自动化：packages 与 Blueprint|第七章 场景模板与自动化]]
