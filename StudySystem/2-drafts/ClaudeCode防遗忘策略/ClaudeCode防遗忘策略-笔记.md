...
```
┌─────────────────────────────────────────┐
│          监督校验层 (MCP/Checkpoint)      │  ← 强制打断，人类/脚本验收
├─────────────────────────────────────────┤
│          宏观思考层 (Skill + TODO.md)     │  ← SOP 下发 + 实体进度文件
├─────────────────────────────────────────┤
│          微观机械层 (Hook)                │  ← 格式化、重启等固定动作
└─────────────────────────────────────────┘
```
...
> **核心原则**：不要让 AI "记住" 规范，而要让 AI 被规范 "驱动"——通过文件读写和工具调用来约束行为。
